...
export class MoveAction extends Action {
    ...
    start() {
        this.active = true;
        this.pathIndex = 1;
        eventSystem.publish("entity:move:start", { entity: this.entity });
    }
        ...
        this.entity.publish("action:end", { entity: this.entity });
        eventSystem.publish("entity:move:end", { entity: this.entity });
    }
    ...
    moveTo(targetCell) {
        ...
        eventSystem.publish("entity:move", { entity: this.entity });
...
export class MeleeAttackAction extends Action {
    ...
    dealDamage() {
        ...
        eventSystem.publish("entity:attack", { entity: this.entity });
    }
...
export class RangedAttackAction extends Action {
    ...
    start() {
        ...
        this.entity.publish("action:end", { entity: this.entity });
        eventSystem.publish("move:end", { entity: this.entity });
        this.active = false;
    }
